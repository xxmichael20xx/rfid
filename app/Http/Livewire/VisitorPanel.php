...
class VisitorPanel extends Component
{
    /**
        ...
        if (! $visitorToken) {
            ...
            if (! $isTimeIn && ! $isTimeOut) {
                ...
                if ($isTimeIn) {
                    ...
                    $this->emitTo('guard.visitor.guard-visitor-exit', 'showVisitorExit', ['id' => $visitorToken->home_owner_id, 'visitorId' => $visitorToken->id]);
                }
            }
        }
    }
    ...
    {
        return view('livewire.visitor-panel')
