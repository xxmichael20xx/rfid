<div>
    <div class="modal fade" id="showVisitorExitModal" tabindex="-1" aria-labelledby="showVisitorExitModalLabel" aria-hidden="true" wire:ignore.self>
    ...
    <script>
        let showVisitorExitModal

        $(document).ready(function() {
            /** Define event to display the modal */
            Livewire.on('show.visitor-exit', function() {
                showVisitorExitModal = new bootstrap.Modal('#showVisitorExitModal', {
                    backdrop: 'static',
                    keyboard: false
                })
                showVisitorExitModal.show()
            ...
            Livewire.on('close.visitor-exit', function(e) {
                // restartSnapshot()

                showVisitorExitModal.hide()
